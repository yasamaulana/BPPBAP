                            ...
                            <div class="col-md-9">
                                <div class="p-3">
                                    <div class="text-center">
                                        <img src="img/simpel-kontek.png" class="justify-content-center mt-5" id="logoatas"
                                    ...
                                    <form action="/login" method="post">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <div class="input-group has-validation">
                                                ...
                                                <input type="text" class="form-control @error('email') is-invalid @enderror" id="username" value="{{ old('email') }}"
                                                 name="email" aria-describedby="inputGroupPrepend" required placeholder="Username">
                                            </div>
                                            @error('email')
