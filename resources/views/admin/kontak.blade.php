        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="d-sm-flex align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Kontak 24 Jam</h6>
                    <div class="ms-auto">
            ...
            <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="{{ url('/kontak-24jam') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                    ...
                    <table class="table table" id="table" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            @foreach ($datas as $key => $value)
                                <tr>
                                    <td>
                                        <img src="{{ asset('storage/kontak/' . $value->icon) }}" alt=""
                                            width="40">
                                    </td>
                                    <td>{{ $value->judul }}</td>
                                    <td>{{ $value->link }}</td>
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ url('/kontak-24jam/' . $value->id . '/edit') }}"><button
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="{{ url('/kontak-24jam/' . $value->id) }}" method="POST">
                                                    @csrf
