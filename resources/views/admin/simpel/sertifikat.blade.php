        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="d-sm-flex align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Layanan Informasi Sertifikasi Kompetensi</h6>
                    <div class="ms-auto">
                    ...
                    <table class="table table" id="table" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            @foreach ($datas as $key => $value)
                                <tr>
                                    <td>
                                        <img src="{{ asset('storage/sertifikat/' . $value->icon) }}" alt=""
                                            width="40">
                                    </td>
                                    <td>{{ $value->judul }}</td>
                                    <td>{{ $value->link }}</td>
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ url('/sertifikat/' . $value->id . '/edit') }}"><button
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="{{ url('/sertifikat/' . $value->id) }}" method="POST">
                                                    @csrf
