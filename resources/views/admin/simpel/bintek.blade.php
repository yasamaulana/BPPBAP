            ...
            <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="{{ url('/bintek-penelitian-kerjasama') }}" method="POST"
                    ...
                    <table class="table table" id="table" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            @foreach ($datas as $key => $value)
                                <tr>
                                    <td>
                                        <img src="{{ asset('storage/bintek/' . $value->icon) }}" alt=""
                                            width="40">
                                    </td>
                                    <td>{{ $value->judul }}</td>
                                    <td>{{ $value->link }}</td>
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ url('/bintek-penelitian-kerjasama/' . $value->id . '/edit') }}"><button
