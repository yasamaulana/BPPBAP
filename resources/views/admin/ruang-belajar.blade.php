            ...
            <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="{{ url('/ruang-belajar-pasif') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                    ...
                    <table class="table table" id="table" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            @foreach ($datas as $key => $value)
                                <tr>
                                    <td>
                                        <img src="{{ asset('storage/belajar/' . $value->icon) }}" alt=""
                                            width="40">
                                    </td>
                                    <td>{{ $value->judul }}</td>
                                    <td>{{ $value->link }}</td>
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ url('/ruang-belajar-pasif/' . $value->id . '/edit') }}"><button
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="{{ url('/ruang-belajar-pasif/' . $value->id) }}"
                                                    method="POST">
                                                    @csrf
