...
<head>
    ...
    <title>Edit Data Goes Mbak Tri</title>
...
<body style="background-color: whitesmoke">
    <div class="mx-auto m-5" style="width: 70%">
        <a href="/goes-mbak-tri"><button class="btn btn-primary mb-2"><i
                    class="fa-solid fa-circle-chevron-left me-2"></i>Kembali</button></a>
        <div class="card shadow">
            <form action="{{ url('/goes-mbak-tri/' . $model->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-header grid bg-primary">
                    <h4 class="text-white text-center mt-2 g-col-4">Edit Data Goes Mbak Tri</h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="jabatan" name="kabupaten"
                            placeholder="Kabupaten" required value="{{ $model->kabupaten }}">
                    </div>
                    <div class="mb-3">
                        <label for="email" class="form-label">Link/Whatsapp</label>
