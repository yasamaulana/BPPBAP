...
<head>
    ...
    <title>Edit Data Edit Ifo Terkini</title>
...
<body style="background-color: whitesmoke">
    <div class="mx-auto m-5" style="width: 70%">
        <a href="/info-terkini"><button class="btn btn-primary mb-2"><i
                    class="fa-solid fa-circle-chevron-left me-2"></i>Kembali</button></a>
        <div class="card shadow">
            <form action="{{ url('/info-terkini/' . $model->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-header grid bg-primary">
                    <h4 class="text-white text-center mt-2 g-col-4">Edit Data Edit Ifo Terkini</h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="nama" name="gambar" placeholder="Gambar"
                    ...
                    <div class="mb-3">
                        <label for="email" class="form-label">Text Sinkat Info</label>
                        <input type="text" class="form-control" id="email" name="text" placeholder="Info"
                            required value="{{ $model->text }}">
                    </div>
                </div>
