...
<head>
    ...
    <title>Edit Layanan Bantuan Pemerintah</title>
...
<body style="background-color: whitesmoke">
    <div class="mx-auto m-5" style="width: 70%">
        <a href="/bantuan-pemerintah"><button class="btn btn-primary mb-2"><i
                    class="fa-solid fa-circle-chevron-left me-2"></i>Kembali</button></a>
        <div class="card shadow">
            <form action="{{ url('/bantuan-pemerintah/' . $model->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-header grid bg-primary">
                    <h4 class="text-white text-center mt-2 g-col-4">Edit Data Sertifikasi Kompetensi</h4>
                </div>
                <div class="card-body">
