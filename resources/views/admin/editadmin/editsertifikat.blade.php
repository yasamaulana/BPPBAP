...
<head>
    ...
    <title>Edit Data Sertifikasi Kompetensi</title>
...
<body style="background-color: whitesmoke">
    <div class="mx-auto m-5" style="width: 70%">
        <a href="/sertifikat"><button class="btn btn-primary mb-2"><i
                    class="fa-solid fa-circle-chevron-left me-2"></i>Kembali</button></a>
        <div class="card shadow">
            <form action="{{ url('/sertifikat/' . $model->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
