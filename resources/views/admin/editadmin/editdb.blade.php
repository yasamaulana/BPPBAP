...
<body style="background-color: whitesmoke">
    <div class="mx-auto m-5" style="width: 70%">
        <a href="/database-informasi"><button class="btn btn-primary mb-2"><i
        ...
        <div class="card shadow">
            <form action="{{ url('/database-informasi/' . $model->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" value="{{ $model->grafik }}" name="grafiklama">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="nama" class="form-label">Grafik</label>
